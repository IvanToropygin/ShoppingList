...
import com.stepik.shoppinglist.domain.AddShopItemUseCase
import com.stepik.shoppinglist.domain.EditShopItemUseCase
import com.stepik.shoppinglist.domain.GetShopItemUseCase
...
//            val shopItem = ShopItem(name = name, count = count, enabled = true)
    ...
    private fun parseCount(inputCount: String?) = inputCount?.trim()?.toDoubleOrNull() ?: 0.0
